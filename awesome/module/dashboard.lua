...
local buildButton = function(icon, _)
...
-- Bookmarks
local function reddit_command()
	dashboard_hide()
	awful.spawn(apps.default.browser .. " " .. "reddit.com")
end

local function youtube_command()
	dashboard_hide()
...
local function files_command(directory)
	dashboard_hide()
...
local bookmarks = wibox.widget({
	{
		{ youtube, github, reddit, layout = wibox.layout.flex.horizontal },
